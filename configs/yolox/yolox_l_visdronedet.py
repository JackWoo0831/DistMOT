...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/wujiapeng/datasets/VisDrone2019_DET/annotations/train_mmdet.json', 
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/wujiapeng/datasets/VisDrone2019_DET/annotations/test_mmdet.json',
