...
if __name__ == '__main__':
    ...
    # CUDA_VISIBLE_DEVICES=1 python tools/mot_demo.py ./uav0000339_00001_v configs/qdtrack/qdtrack_visdrone_baseline.py --checkpoint ckpts/qdtrack/epoch_10.pth --out test_30
